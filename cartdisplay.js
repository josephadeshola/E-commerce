...
function getlocalItem() {
  ...
  if (carts.length == 0) {
    setTimeout(()=>{
      productNotFound.innerHTML="<center><div class='border part rounded shadow border-1 '><center>  <div class='border roundimg mt-4 shadow text-info  border-1 py-2 '><i class='mt-2 bi bi-cart-dash-fill  cartImg'></i></div> <b>Your cart is empty!</b> <br> <h4>item is not added yet </h4><div class='mb-5'><button class='btn btn-info text-light'> <a href='./productpage.html' class='text-decoration-none text-light'> Start Shopping</a></button></div></center> </div></center>"
